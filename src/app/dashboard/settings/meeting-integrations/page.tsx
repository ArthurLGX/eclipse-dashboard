      ...
      >
                ...
                >
                  <div className="flex items-start gap-4">
                        ...
                        <div className="mt-4 !space-y-4">
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              <code className="flex-1 px-3 py-2 bg-card  !text-sm font-mono !text-accent-text overflow-x-auto">
                                {webhookUrl}
                              </code>
                              <button
                    ...
                    {!step.completed && currentStep === step.id && (
                      <IconChevronRight className="w-5 h-5 !text-accent-text animate-pulse" />
                    )}
                  </div>
                </motion.div>
              ))}
        ...
        <div className="bg-card p-4">
          <h2 className="!text-lg font-semibold !text-primary mb-4 flex items-center gap-2">
            <IconNotes className="w-5 h-5 !text-accent-text" />
            Comment ça marche ?
          </h2>
            ...
            {[
              ...
              <div key={i} className="!text-center p-4">
                <div className="w-12 h-12 rounded-full bg-accent-light flex items-center justify-center mx-auto mb-3">
                  <item.icon className="w-6 h-6 !text-accent-text" />
                </div>
        ...
        {/* Pro Tips */}
        <div className="bg-card p-4 bg-accent-light border border-accent">
