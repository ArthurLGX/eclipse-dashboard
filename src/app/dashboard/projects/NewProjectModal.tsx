    ...
    <FloatingModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-5">
        <div className="p-2 bg-accent-light  border border-accent">
          <IconFolderPlus size={22} className="!text-accent-text" />
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div>
            <label className="flex items-center gap-1.5 !text-secondary !text-xs mb-1.5 font-medium">
              ...
              {t('title') || 'Titre'} <span className="!text-accent-text">*</span>
            </label>
            <input
              ref={titleInputRef}
              type="text"
          ...
          <div>
            <label className="flex items-center gap-1.5 !text-secondary !text-xs mb-1.5 font-medium">
              ...
              {t('type') || 'Type'} <span className="!text-accent-text">*</span>
            </label>
            <select
              required
              value={type}
        ...
        <div>
          <label className="flex items-center gap-1.5 !text-secondary !text-xs mb-1.5 font-medium">
            ...
            {t('description') || 'Description'} <span className="!text-accent-text">*</span>
          </label>
          <textarea
        ...
        <div className="grid grid-cols-3 gap-3">
          <div>
            <label className="!text-secondary !text-xs mb-1.5 font-medium block">
              {t('status') || 'Statut'} <span className="!text-accent-text">*</span>
            </label>
            <select
              required
              value={projectStatus}
          ...
          <div>
            <label className="flex items-center gap-1 !text-secondary !text-xs mb-1.5 font-medium">
              ...
              Début <span className="!text-accent-text">*</span>
            </label>
            <input
              type="date"
              required
          ...
          <div>
            <label className="flex items-center gap-1 !text-secondary !text-xs mb-1.5 font-medium">
              <IconCalendar size={12} className="!text-muted" />
              Fin <span className="!text-accent-text">*</span>
            </label>
            <input
              type="date"
              required
