              ...
              <div className="p-4 border-b border-muted">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    ...
                    <span className="!text-xs px-2 py-0.5 rounded-full bg-accent-light !text-accent-text">
                ...
                <div className="space-y-1">
                  {(template.tasks || []).slice(0, 5).map((task, idx) => (
                    <div key={idx} className="flex items-center gap-2 !text-xs">
                      <div className="w-4 h-4 rounded bg-accent-light flex items-center justify-center !text-accent-text font-medium">
                        {idx + 1}
                      </div>
