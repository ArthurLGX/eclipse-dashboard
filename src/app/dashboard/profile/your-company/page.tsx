        ...
        {!editing ? (
          <div className="flex lg:flex-row flex-col lg:w-fit w-full gap-4">
            {companyProfile ? (
              <button
                ...
                className="btn-primary lg:w-fit w-full px-4 py-2  transition-all ease-in-out duration-300"
              >
                {t('edit_enterprise')}
              </button>
            ) : (
              <button
                ...
                className="btn-primary px-4 py-2  transition-all ease-in-out duration-300"
              >
          ...
          <div className="flex lg:flex-row flex-col lg:w-fit w-full gap-4">
            <button
              ...
              className="bg-warning-light lg:w-fit w-full !text-warning-text border border-warning px-4 py-2 hover:opacity-80  cursor-pointer transition-colors ease-in-out duration-300"
            >
              {t('cancel')}
            </button>
            <button
