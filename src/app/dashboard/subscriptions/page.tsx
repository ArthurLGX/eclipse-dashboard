        ...
        <form onSubmit={handleSubmit} className="p-4 !space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 bg-page border border-muted  !pr-8"
                  required
                />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-page border border-muted  resize-none"
              rows={2}
    ...
    <div className="p-6 !space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center gap-3">
          <IconCreditCard size={28} className="!text-accent-text" />
          <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-muted  p-4">
          ...
          <p className="!text-2xl font-bold !text-accent-text">{formatCurrency(stats.monthlyRevenue)}</p>
        </div>
        <div className="bg-card border border-muted  p-4">
