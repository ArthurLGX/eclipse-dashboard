  ...
  const sidebarItems: SidebarItem[] = useMemo(() => [
    {
      ...
      labelEn: 'Overview',
      icon: <IconLayoutDashboard size={10} stroke={1} />,
      path: '/admin',
    },
    {
      id: 'users',
      label: 'Utilisateurs',
      labelEn: 'Users',
      icon: <IconUsers size={10} stroke={1} />,
      path: '/admin/users',
    },
    {
      id: 'subscriptions',
      ...
      icon: <IconCreditCard size={10} stroke={1} />,
    ...
    },
    {
      ...
      label: 'Serveur',
      labelEn: 'Server',
      icon: <IconServer size={10} stroke={1} />,
      path: '/admin/server',
    },
    {
      id: 'logs',
      label: 'Logs & Audit',
      labelEn: 'Logs & Audit',
      icon: <IconHistory size={10} stroke={1} />,
      path: '/admin/logs',
    },
    {
      id: 'module',
      label: 'Modules',
      labelEn: 'Modules',
      icon: <IconPuzzle size={10} stroke={1} />,
      path: '/admin/modules',
    },
    {
      id: 'settings',
      label: 'Configuration',
      labelEn: 'Settings',
      icon: <IconSettings size={10} stroke={1} />,
      path: '/admin/settings',
    },
    {
      id: 'back',
      ...
      icon: <IconChevronLeft size={10} stroke={1} />,
      path: '/dashboard',
    },
    {
      id: 'logout',
      label: 'Déconnexion',
      labelEn: 'Logout',
          icon: <IconLogout size={10} stroke={1} />,
      onClick: logout,
      path: '/login',
    },
  ], [logout]);
          ...
          <div className="flex flex-col items-center w-full justify-between gap-4 p-4">
            ...
            >
              {isExpanded || isPinned ? (
                ...
                <IconShield size={28} className="!text-accent-text" />
              )}
            </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  >
                    {resolvedMode === 'dark' ? (
                      ...
                      <IconMoon size={16} className="!text-accent-text" />
                    )}
                  </button>
                  {/* Pin Button */}
                  <button
                  ...
                  >
                    {isPinned ? (
                      <IconPinFilled size={16} className="!text-accent-text" />
                    ) : (
