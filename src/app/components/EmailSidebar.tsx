      ...
      <div className="p-4">
        <div className="relative">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 bg-accent hover:opacity-90 !text-white  transition-all shadow-lg group"
          >
            ...
            {showNewMenu && (
              <>
                ...
                <motion.div
                  ...
                  className="absolute top-full left-0 mt-2 w-full bg-card border border-default  shadow-xl overflow-hidden z-20"
                >
                  <button
                    onClick={() => {
                      onNewMessage();
