    ...
    <div className="space-y-4 mb-6">
      ...
      <AnimatePresence>
        {showAdvanced && advancedFilters.length > 0 && (
          ...
          >
            <div className="p-4 lg:p-5 rounded-lg bg-card border border-default shadow-sm">
              {/* Header */}
                        ...
                        <AnimatePresence>
                          {openMultiSelect === filter.id && (
                            <motion.div
                              ...
                              exit={{ opacity: 0, y: -10 }}
                              className="absolute z-50 top-full left-0 right-0 mt-1 rounded-lg bg-card border border-default shadow-lg max-h-48 overflow-y-auto"
                            >
                              {filter.options.map(opt => {
