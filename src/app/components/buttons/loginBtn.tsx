    ...
    return (
        <div className="flex w-fit flex-row items-center gap-4">
            <Link
                id="loginBtn"
                href="/login"
                className={`group flex flex-row items-center justify-center gap-2 text-zinc-200 !text-xs capitalize border border-zinc-700 rounded-sm bg-zinc-900 hover:bg-zinc-950 !px-4 !py-2  transition-all ease-in-out duration-300 `}
            >
