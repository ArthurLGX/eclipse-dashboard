        ...
        >
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="!text-muted mt-1">
                ...
                <span className="font-bold !text-accent-text">{quota}</span>.
              </p>
          ...
          <div className="flex items-center justify-between gap-4 p-3  bg-muted/10 mb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={selectAll}
                className="!text-xs px-2 py-1 rounded bg-accent-light !text-accent-text hover:bg-accent-light transition-colors"
              >
