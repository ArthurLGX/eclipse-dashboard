    ...
    <div className={`bg-card border border-default  overflow-hidden ${className}`}>
      ...
      <div className="px-4 py-3 border-b border-default flex items-center justify-between">
        <div className="flex items-center gap-2">
          <IconCode size={18} className="!text-accent-text" />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {activeSession.project && (
                    ...
                    >
                      ...
                      <span className="!text-sm font-medium !text-primary group-hover:!text-accent-text transition-colors truncate">
                  ...
                  {activeSession.client && (
                    ...
                    >
                      ...
                      <span className="!text-xs !text-muted group-hover:!text-accent-text transition-colors truncate">
      ...
      <div className="p-4">
            ...
            {recentSessions.slice(0, 5).map((session) => (
              ...
              >
                <div className="w-8 h-8  bg-accent-light flex items-center justify-center flex-shrink-0">
                  <IconCode size={16} className="!text-accent-text" />
                </div>
        ...
        <Link
          ...
          className="block mt-3 !text-center !text-xs !text-accent-text hover:underline"
        >
