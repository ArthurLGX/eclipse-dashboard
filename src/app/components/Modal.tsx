  ...
  return (
    ...
    >
      <div 
        ref={modalRef}
        tabIndex={-1}
        className="bg-card border border-default rounded-lg shadow-2xl relative min-w-[350px] max-w-[90vw] max-h-[90vh] overflow-auto print-modal outline-none overscroll-contain"
        onWheel={(e) => e.stopPropagation()}
      >
        <button
          onClick={onClose}
