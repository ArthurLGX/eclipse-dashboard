    ...
    <>
      <div className="bg-card border border-default  p-6 !space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 !text-sm bg-accent-light !text-accent-text hover:bg-accent hover:!text-white  transition-colors"
            >
          ...
          >
            ...
            <div className={`mx-auto transition-all duration-300 ${
              previewMode === 'mobile' ? 'max-w-[375px]' : 'max-w-full'
                ...
                <div className="email-preview-light p-6  border border-muted">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {formData.logo_url ? (
                  <div className="relative">
                    ...
                    <img 
                      ...
                      alt="Logo" 
                      className="w-16 h-16 object-contain  border border-default bg-white"
                    />
                    <button
                  ...
                  <button
                    ...
                    className="w-16 h-16 border-2 border-dashed border-default  flex items-center justify-center !text-muted hover:border-accent hover:!text-accent-text transition-colors"
                  >
          ...
          <div className="space-y-4">
            <h4 className="font-medium !text-primary flex items-center gap-2">
              <IconPhone className="w-4 h-4 !text-accent-text" />
        ...
        <div className="pt-4 border-t border-default">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 !text-sm bg-accent-light !text-accent-text hover:bg-accent-light  transition-colors"
            >
              ...
              {(formData.social_links || []).map((link, index) => {
                ...
                return (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="flex items-center gap-3 p-3 bg-muted  border border-default"
                  >
                    {/* Drag handle */}
                    ...
                    <button
                      ...
                      className="p-2 !text-danger/70 hover:!text-danger hover:bg-danger-light  transition-colors"
                    >
        ...
        <div className="pt-4 border-t border-default">
          <button
            onClick={() => setShowCustomization(!showCustomization)}
              className="flex items-center justify-between w-full p-3 bg-accent-light hover:bg-accent  transition-colors"
          >
                ...
                <div className="pt-4 !space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-2 bg-muted/20  appearance-none cursor-pointer accent-accent"
                    />
        ...
        <div className="pt-4 border-t border-default">
          ...
          <div className="mb-4 p-3  bg-muted border border-info">
              ...
              {formData.banner_url ? (
                <div className="relative inline-block">
                  ...
                  <img 
                    ...
                    className="max-w-full h-auto max-h-32 object-contain  border border-default bg-white"
                  />
                  <button
                ...
                <button
                  ...
                  className="w-full h-24 border-2 border-dashed border-default  flex flex-col items-center justify-center !text-muted hover:border-accent hover:!text-accent-text transition-colors"
                >
        ...
        <div className="flex justify-end pt-4 border-t border-default">
          <button
            onClick={handleSave}
            disabled={saving}
                className="flex items-center gap-2 px-6 py-2.5 bg-accent !text-white  hover:bg-accent transition-colors disabled:opacity-50"
          >
            {saving ? (
              <>
