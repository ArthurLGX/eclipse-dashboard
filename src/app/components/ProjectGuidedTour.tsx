                ...
                >
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      ...
                      />
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-accent/20 to-accent/5 flex items-center justify-center !text-accent-text">
                        {step.icon}
                      </div>
                    </motion.div>
                  </div>
                  ...
                  {currentStep === 0 && projectTitle && (
                    <div className="flex justify-center">
                      <span className="px-3 py-1 bg-accent-light !text-accent-text rounded-full !text-sm font-medium">
                        {projectTitle}
                      </span>
                    </div>
                  )}
