  ...
  return (
    <div className="flex flex-row lg:items-center items-start gap-2">
      ...
      <select
        ...
        className="px-2 py-1 cursor-pointer lg:w-fit w-full bg-card border border-default rounded-lg text-primary !text-sm focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent hover:bg-hover transition-colors"
      >
